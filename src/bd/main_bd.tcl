...
#  -string -flagsOSRD
preplace port sfp_signal_detect -pg 1 -y 1200 -defaultsOSRD
preplace port rst_cpld_bridge -pg 1 -y 90 -defaultsOSRD
...
preplace port clk_ref_200 -pg 1 -y 1100 -defaultsOSRD
